...
const ProjectLab = () => {
  ...
  const categories = {
    "Web Development": [
      "Online Job Portal", "Online Shopping System", "Online Food Ordering System", 
      "Portfolio Builder Platform", "Hospital Management System", "School ERP System", 
      "Event Management System", "Online Voting System", "Online Movie Ticket Booking System", 
      "Weather Forecast Dashboard", "Online Book Store", "Car Rental System", 
      "Library Management System", "Online Job Seeking Application", "Online Home Stay", 
      "Tourist Management System"
    ],
    "Data Science & Analytics": [
      "Healthcare Data Analysis", "Student Performance Analysis", "College Dropout Prediction", 
      "Credit Card Fraud Detection", "Placement Chance Prediction", "Food Delivery Time Prediction", 
      "Sentiment Analysis of Feedback", "Loan Approval Prediction", "Movie Recommendation System", 
      "Supermarket Sales Dashboard", "Fake News Detection", "Used Car Price Prediction", 
      "Retail Sales Dashboard", "House Price Prediction", "Flight Price Prediction"
    ],
    "AI/ML Projects": [
      "AI Chatbot", "Number Guessing Game with AI", "Voice Calculator", "Face Detection System", 
      "Smart Attendance System", "Text-to-Speech Converter", "Image Caption Generator", 
      "AI Math Solver", "AI Name Suggester"
    ],
    "IoT Systems": [
      "Smart Dustbin", "Home Automation System", "IoT Door Lock", "Smart Attendance System", 
      "Smart Street Lighting", "IoT Smart Mirror"
    ]
  };

  const allProjects = Object.entries(categories).flatMap(([category, projects]) => 
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {activeCategory === 'All' ? (
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {Object.entries(categories).map(([title, items]) => (
              <div key={title} className="bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100">
            ...
            {filteredProjects.map((item, index) => (
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-gray-800">{item.project}</h3>
                </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-center">
          ...
          <p className="text-blue-100 max-w-2xl mx-auto mb-6">
            Join thousands of developers building innovative projects with our resources and tools
          </p>
